...
function loadData(map, year){
    $.ajax("https://timprestby.github.io/portfolio/nativeAmerica/data/NativeLand1880On.geojson", {
        dataType: "json",
    ...
    $.ajax("https://timprestby.github.io/portfolio/nativeAmerica/data/NativeLandPre1880.geojson", {
        dataType: "json",
        success: function(response){
            // Sort the data in yearMap by year
            processData(response);
    ...
    $.ajax("https://timprestby.github.io/portfolio/nativeAmerica/data/LandLostWithoutTreaty.geojson", {
        dataType: "json",
        success: function(response){
            // Sort the data in yearMap by year
            processData(response);
